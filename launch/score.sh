...
python predict_skeleton.py --predict_data_list data/val_list_m.txt --data_root data --model_name $skeleton_model_name --pretrained_model '/home/ubuntu/jittor2025_skeleton/output/skeleton/multiheadsa+patience10/best_model.pkl' --predict_output_dir predict/$skeleton_model_name --batch_size 24
